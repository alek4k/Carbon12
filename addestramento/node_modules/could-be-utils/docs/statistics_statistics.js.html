...
<head>
    ...
    <meta charset="utf-8">
    <title>JSDoc: statistics/statistics.js</title>
...
<body>
            ...
            <div class="column is-9-desktop">
                <div class="content" id="main-content-wrapper">
                    <header class="page-title">
                        <p>Source</p>
                        <h1>statistics/statistics.js</h1>
                    </header>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const zeros = require("../array/array").zeros;
/**
 * @name variance
 * @description
